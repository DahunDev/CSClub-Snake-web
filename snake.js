...
export const SNAKE_SPEED = 6; //allow to import this for other js file

const snakeBody = [{x: 11, y:11}] //const only applied for outer, so can element data in array
...
export function updateSnake() {
  ...
  for (let i = snakeBody.length - 2; i >= 0; i--) {
    snakeBody[i + 1] = { ...snakeBody[i] }; //use {...} to hard copy
  }
